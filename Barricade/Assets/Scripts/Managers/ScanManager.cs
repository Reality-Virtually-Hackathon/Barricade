...
{
    public class ScanManager : Singleton<ScanManager>, ISourceStateHandler, IInputClickHandler
    {
        // Consts
        ...
        public void OnInputClicked(InputClickedEventData eventData)
        {
                ...
                !SpatialUnderstanding.Instance.ScanStatsReportStillWorking)
            {
                ...
                AppStateManager.Instance.ScanningDone();
            }
        }
        ...
        public void DeactivateText()
        {
            ...
            DebugSubDisplay.gameObject.SetActive(false);
        }

        public void ActivateText()
        {
            DebugDisplay.gameObject.SetActive(true);
            DebugSubDisplay.gameObject.SetActive(true);
        }
    }
}
